...
//		private Cairo.ImageSurface surface;
		...
		public double Angle {
			...
			set {
				angle = value;
				Size newSize = Troonie_Lib.RotateBilinear.CalculateNewImageSize (Angle, W, H, false);
...
//		{
//			newSize = Troonie_Lib.RotateBilinear.CalculateNewImageSize (angle, w_old, h_old, false);
