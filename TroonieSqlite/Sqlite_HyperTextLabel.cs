...
namespace TroonieSqlite
{
	...
	public class Sqlite_HyperTextLabel : Gtk.EventBox
	{		
		private DrawingArea da = new DrawingArea();
		private Sqlite_ColorConverter colorConverter = Sqlite_ColorConverter.Instance;
