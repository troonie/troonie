...
{
	internal class Sqlite_ColorConverter
	{
...
//			}
		...
		public class BtnNormal : Btn
		{
			...
			public BtnNormal() : base()
			{
				...
				Border = Sqlite_ColorConverter.Instance.C_GRID;
			}
		}
...
//		}
		...
		private static Sqlite_ColorConverter instance;
		public static Sqlite_ColorConverter Instance
		{
			get
			{
				if (instance == null)
					instance = new Sqlite_ColorConverter ();
