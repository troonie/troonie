...
namespace Picturez
{
	...
	public delegate void OnCursorPosChangedStitchImagePanelEventHandler(int x, int y);

	[System.ComponentModel.ToolboxItem (true)]
	public partial class StitchImagePanel : Bin 
	{	
		...
		public OnCursorPosChangedStitchImagePanelEventHandler OnCursorPosChanged;

		public StitchImagePanel ()
		{
//			this.Build ();
			...
			this.Name = "Picturez.StitchImagePanel";
