...
namespace Picturez
{
	public partial class StarterWidget
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Picturez.StarterWidget
			global::Stetic.BinContainer.Attach (this);
			this.WidthRequest = 600;
			this.HeightRequest = 150;
			this.CanFocus = true;
			this.Name = "Picturez.StarterWidget";
			// Container child Picturez.StarterWidget.Gtk.Container+ContainerChild
			...
			this.picBtnConvert = new global::Picturez.PicturezButton ();
			...
			w1.Position = 0;
			// Container child hbox1.Gtk.Box+BoxChild
			this.picBtnEdit = new global::Picturez.PicturezButton ();
			...
			w2.Position = 1;
			// Container child hbox1.Gtk.Box+BoxChild
			this.picBtnSteganography = new global::Picturez.PicturezButton ();
