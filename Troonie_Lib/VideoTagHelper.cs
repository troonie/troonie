...
namespace Troonie_Lib
{
  ...
  //                      switch (result[i])
  //                      {
  //                          case ET_CreateDate: td.CreateDate = tt; break;
  ...
  //                      arg += " -" + ET_CreateDate + "=" + ExifTool.DateTimeToString(td.CreateDate);
  //                      break;
  ...
  //                      string sdate = "=" + ExifTool.DateTimeToString(td.CreateDate); 
