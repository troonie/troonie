...
//			CombinedImageTag t = target as CombinedImageTag;
//
//			if (overwrite || IsNullOrLikeEmpty (t.Title))
//				t.Title = Title;
//
//			if (overwrite || IsNullOrLikeEmpty (t.Comment))
//				t.Comment = Comment;
//
//			if (overwrite || IsNullOrLikeEmpty (t.Copyright))
//				t.Copyright = Copyright;
//
//			if (overwrite || t.TagTypes == TagTypes.None)
//				t.TagTypes = TagTypes;
//		}

//		/// <summary>
//		/// Copies properties of passed tag. If overwrite is true, 
//		/// the copy process will be forced, also when own property is already set. 
//		/// Otherwise only copy, if own value is not set.
//		/// </summary>
//		public override void PIC_ENHANCE_CopyFrom(ImageTag t, bool overwrite)
//		{
//			base.PIC_ENHANCE_CopyFrom (t, overwrite);
//
//			if ((!IsNullOrLikeEmpty (Title) && !IsNullOrLikeEmpty (t.Title) && overwrite) || IsNullOrLikeEmpty (Title))
//				this.Title = t.Title;
//
//			if ((!IsNullOrLikeEmpty (Comment) && !IsNullOrLikeEmpty (t.Comment) && overwrite) || IsNullOrLikeEmpty (Comment))
//				this.Comment = t.Comment;
//
//			if ((!IsNullOrLikeEmpty (Copyright) && !IsNullOrLikeEmpty (t.Copyright) && overwrite) || IsNullOrLikeEmpty (Copyright))
//				this.Copyright = t.Copyright;
//		}

		public void PIC_ENHANCE_AddTag (ImageTag tag)
		{
			AddTag (tag);
		}
